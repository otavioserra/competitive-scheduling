<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        <a href="?page=competitive_scheduling_settings&tab=pages" class="nav-tab <?php echo $active_tab == 'pages' ? 'nav-tab-active' : ''; ?>"><?php esc_html_e( 'Pages', 'competitive-scheduling' ); ?></a>
    ...
    <?php 
        ...
        switch($active_tab) {
            ...
            break;
            case 'pages':
                settings_fields( 'competitive_scheduling_group_pages_options' );
                do_settings_sections( 'competitive_scheduling_pages' );
            break;
            default:
                settings_fields( 'competitive_scheduling_group_options' );
                do_settings_sections( 'competitive_scheduling_main' );
